...
The user rates themselves (1–10) on each characteristic, one at a time. Each screen includes characteristic-anchored bands (1–3, 4–6, 7–8, 9–10) with behavioral descriptions tailored to the characteristic.
